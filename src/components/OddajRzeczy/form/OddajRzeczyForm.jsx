  ...
  return (
    <>
      {currentStep === 1 && (
        <Step1
          nextStep={nextStep}
          handleSelectedChecbkboxes={handleSelectedChecbkboxes}
          existingData={SelectedCheckboxes}
        />
      )}
      {currentStep === 2 && (
        <Step2
          nextStep={nextStep}
          prevStep={prevStep}
          handleselectedSelect_step2={handleselectedSelect_step2}
          existingData={selectedSelect_step2}
        />
      )}
      {currentStep === 3 && (
        <Step3
